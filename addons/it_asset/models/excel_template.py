...
class ITAssetExcelTemplate(models.AbstractModel):
    ...
    def export_damage_report_excel(self, report_id):
        ...
        cell_data = {
            ...
            'K17': report.asset_id.model if report.asset_id and report.asset_id.model else '',
    ...
    def export_material_request_excel(self, request_id):
        ...
        for idx, line in enumerate(request.line_ids, start=1):
            ...
            cell_data[f'AH{current_row}'] = line.quantity
            cell_data[f'AK{current_row}'] = line.uom or ''
            cell_data[f'AU{current_row}'] = line.purpose or ''
